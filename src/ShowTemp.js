        ...
        <div class="container my-5">
            <div class="row mb-2">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Temp (in kelvin)</h5>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Temp Min (in kelvin)</h5>
            ...
            <div class="row mb-2">
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Temp Max (in kelvin)</h5>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Humidity (in %)</h5>
